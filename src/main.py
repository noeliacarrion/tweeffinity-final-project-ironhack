...
def main():
    ...
    data_embedding_user, embedding_user = get_similarity.embeddingUmap(2, 8, 42, tfidf_matrix_user, tfidf_matrix_user)
    data_embedding_friend, embedding_friend = get_similarity.embeddingUmap(2, 5, 42, tfidf_matrix_user,
                                                                           tfidf_matrix_friend)

    plotEmbedding(data_embedding_user, data_embedding_friend, 'emb_1', 'emb_2', 'Spectral', 8, 'Umap Proyection', 12)

    cluster_user, label_user = get_similarity.clustering(embedding_user, embedding_user, 11, True)
